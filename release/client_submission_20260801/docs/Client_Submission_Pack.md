...
2. Add a one-command smoke script that validates ETL -> ML -> prediction for handover acceptance.
3. Add a sample sanitized `.env.example` file for client onboarding.